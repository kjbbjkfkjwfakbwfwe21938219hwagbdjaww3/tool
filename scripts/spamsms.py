...
phone = input(f"{xanh_duong}Nhập số điện thoại:{trang} ")
delay = float(input(f"{cyan}Nhập độ trễ (giây) giữa các lần gửi tin nhắn (đặt 0 để chạy đồng thời):{trang} {green}"))
